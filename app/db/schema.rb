...
ActiveRecord::Schema.define(version: 20180610135203) do
  ...
  create_table "bsag_mep_audios", force: :cascade do |t|
    ...
    t.string   "audio_fault_comment",     limit: 255
    t.integer  "bsag_mep_evaluation_id",  limit: 4,                           null: false
    t.datetime "created_at",                                                  null: false
    t.datetime "updated_at",                                                  null: false
  end

  add_index "bsag_mep_audios", ["bsag_audio_fault_id"], name: "index_bsag_mep_audios_on_bsag_audio_fault_id", using: :btree
  ...
  create_table "bsag_product_categories", force: :cascade do |t|
    t.string   "name",       limit: 20,                null: false
  ...
  add_foreign_key "bsag_mep_audios", "bsag_audio_faults"
